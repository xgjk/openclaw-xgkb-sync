 ...
 */
exports.DOWNLOAD_BLOCK_COOLDOWN_MS = 15 * 60_000;
/**
 * 知识库业务层限流错误码集合。
...
exports.DEFAULT_MASS_SYNC_PROTECTION_ENABLED = true;
exports.DEFAULT_MAX_UPLOAD_FILES_PER_SYNC = 1_000;
exports.DEFAULT_MAX_DOWNLOAD_FILES_PER_SYNC = 1_000;
exports.MAX_FILES_PER_SYNC_LIMIT = 1_000_000;
/** watcher debounce 期间最多保留的唯一路径；超出后只累计数量，不再持有路径字符串。 */
exports.MAX_PENDING_WATCH_PATHS = 1_024;
/** 单轮目录 inode move 检测允许解析的目标父目录上限。 */
exports.MAX_FOLDER_ID_RESOLVES_PER_SYNC = 100;
/** 单类批量操作每轮最多输出多少条进度日志，避免大 mapping 形成日志风暴。 */
exports.SYNC_PROGRESS_LOG_MAX_STEPS = 20;
